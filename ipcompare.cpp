...
void IPCompare::drawCirclesAndLine()
{
    QGraphicsEllipseItem *circle1
        = new QGraphicsEllipseItem(-params.r1, -params.r1, 2 * params.r1, 2 * params.r1);
    QGraphicsEllipseItem *circle2
        = new QGraphicsEllipseItem(-params.r2, -params.r2, 2 * params.r2, 2 * params.r2);

    // Set positions of circles
    circle1->setPos(0, 0);
    circle2->setPos(
        params.d, 0); // Assuming the distance is from the center of circle1 to the center of circle2
